...
document.getElementById('btn-confirm').addEventListener('click', () => {
    ...
    var actualTotalCosts = parseFloat(userActual) + parseFloat(userDeploymentActual)

    var offerTotalCosts = parseFloat(userOffer) + parseFloat(userDeploymentOffer)
...
document.getElementById('radio-no').onclick = function () {
    ...
    if (disabled != true) {
        ...
        document.getElementById("input-deployment-expenses").value = 0
    }
}
